# -*- coding: utf-8 -*-
"""
@CreateTime :       2024/05/28 19:25
@File       :       stable_learning.py
@Software   :       PyCharm
@Framework  :       Pytorch
@LastModify :       2024/07/30 23:35
"""

import utils.loss_reweighting as loss_expect
import torch
import torch.nn as nn
from torch.autograd import Variable

from utils.schedule import lr_setter


def weight_learner(cfeatures, pre_features, pre_weight1, args, global_epoch=0, iter=5):
    ...
    weight1 = weight
    return weight1, pre_weight1, lossg
