# -*- coding: utf-8 -*-
"""
@CreateTime :       2024/05/28 19:15
@description:       copy from "https://github.com/KindXiaoming/pykan"
@File       :       KAN.py
@Software   :       PyCharm
@Framework  :       Pytorch
...
class KANLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        x = torch.einsum('ij,k->ikj', x, torch.ones(self.out_dim, device=x.device)).reshape(batch, self.size).permute(1, 0)
